...
export default function HeaderNavigation() {
  ...
  return (
    <OpacityWhenVisible delay={0.1}>
      <nav className="relative z-10 bg-primary max-md:bg-transparent rounded-2xl py-[15px] px-[52px] max-lg:px-5 flex items-center max-lg:justify-between gap-[70px] max-lg:gap-10 max-md:px-2 max-md:py-[5px]">
